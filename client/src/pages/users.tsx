...
const PERMISSION_LABELS: Record<string,string> = { customers:"Customers", leads:"Leads", quotes:"Quotes", schedule:"Schedule", pricebook:"Price Book", invoices:"Invoices", inventory:"Inventory", memberships:"Crown Care", referrals:"Coupons", marketing:"Marketing", automations:"Automations", communications:"Templates & Integrations", reports:"Reports", time_clock:"Time Clock", time_clock_edit_own:"Correct own time entries" };
