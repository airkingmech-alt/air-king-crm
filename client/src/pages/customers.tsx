      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            ...
            residential ·{" "}
            {customers.filter((c) => c.type === "Commercial").length} commercial
          </p>
        </div>
        <Button
          size="sm"
              ...
              <CardContent className="p-4">
                ...
                <Button
                  ...
                  onClick={(event) => {
                    ...
                    window.location.hash = `#/customers/${customer.id}?invoice=new`;
                  }}
                  data-testid={`button-new-invoice-${customer.id}`}
                >
                  <DollarSign size={13} className="mr-1.5" /> New Invoice
                </Button>
              </CardContent>
            </Card>
          </Link>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setForm({
                      ...form,
                      type: v as "Residential" | "Commercial",
                    })
                  }
                >
